...
export const ServerHeader = ({
  ...
  return(
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 text-sc font-medium text-black dark:text-neutral-400 sapce-y-[2px]">
        {isModerator && (
          <DropdownMenuItem 
          onClick={() => onOpen("invite", { server })}
          className="text-cyan-600 dark:text-cyan-400 px-3 py-2 text-sm cursor-pointer">
            Invite People
